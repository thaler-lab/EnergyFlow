...
# emd(ev0, ev1, dists=None, R=1.0, beta=1.0, norm=False, gdim=2, mask=False,
#               return_flow=False, periodic_phi=False,
#               n_iter_max=100000,
#               epsilon_large_factor=1000.0, epsilon_small_factor=1.0)
def emd(ev0, ev1, dists=None, R=1.0, beta=1.0, norm=False, gdim=2, mask=False,
                  return_flow=False, periodic_phi=False,
                  n_iter_max=100000,
                  epsilon_large_factor=1000.0, epsilon_small_factor=1.0,
                  **kwargs):
...
# emds(events0, events1=None, R=1.0, beta=1.0, norm=False, gdim=2, mask=False,
...
def emds(events0, events1=None, pairwise_emd=None,
...
def emd_pot(ev0, ev1, R=1.0, norm=False, beta=1.0, measure='euclidean', coords='hadronic',
    ...
    **Returns**
    ...
    # if this is not importable, function will throw an exception
    global ot, _distance_wrap
    import ot
    ...
    G, cost, _, _, result_code = ot.lp.emd_c(pTs0/rescale, pTs1/rescale, thetas, n_iter_max)
    ot.lp.check_result(result_code)
...
def _emd(ev0, ev1, R, no_norm, beta, euclidean, n_iter_max,
    ...
    _, cost, _, _, result_code = ot.lp.emd_c(pTs0/rescale, pTs1/rescale, thetas, n_iter_max)
    ot.lp.check_result(result_code)
